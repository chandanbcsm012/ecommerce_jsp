...
<section class="terms-of-use">
	...
	<div class="terms">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">
				Privacy Policy <span class="heading-style"> <i></i> <i></i> <i></i>
				</span>
			</h3>
			<!-- //tittle heading -->
			<h6>Privacy Policy</h6>
			<p>We value the trust you place in us. That's why we insist upon
				...
				about our information gathering and dissemination practices.</p>
			...
			<p>Latin professor at Hampden-Sydney College in Virginia, looked
				...
				from sections 1.10.32 and 1.10.33 of "de Finibus Bonorum et Malorum"</p>

...
<div class="copy-right">
	<div class="container">
		<p>
			© 2018 Net Mall. All rights reserved by <a
				href="http://galaxywebsolution.in" sty> Galaxy Web Solution.</a>
		</p>
	</div>
</div>
<!-- //copyright -->
...
<script>
	...
	paypalm.minicartk.cart
			.on(
					'checkout',
					function(evt) {
						var items = this.items(), len = items.length, total = 1, i;
